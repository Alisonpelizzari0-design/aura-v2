...
const MODULE_META = {
  ...
  sante:       { title:'Santé & Corps',       sub:'Rendez-vous · Traitements · Conseils IA',               icon:'ti-heart-rate-monitor'},
  journal:     { title:'Journal intime',      sub:'Ton espace privé · Aucun accès IA',                     icon:'ti-notebook'         },
